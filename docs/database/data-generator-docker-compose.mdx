...
해당 챕터의 전체 코드는 [mlops-for-mle/ch1/](https://github.com/mlops-for-mle/mlops-for-mle/tree/main/ch1) 에서 확인할 수 있습니다.
...
📌 이번 장에서는 Docker Compose 를 이용해 컨테이너를 띄우는 법에 대해서 실습합니다.  
📌 이를 위해서 앞서 1장과 5장에서 시작한 컨테이너를 종료해야 합니다. 
:::
