...
:::
<p>
이번 파트에서는 <Part>04. Model Deployment</Part> 에서 소개한 Event-Driven 방식을 구현 해봅니다.
...
더 자세한 사항은 다음 챕터에서 알아보겠습니다.
</p>
<p>
또한, Stream Serving 뿐만 아니라 원본 데이터와 예측 결과 값을 실시간으로 시각화해주는 대시보드인 Grafana 를 통해 Stream Serving 이 잘 되고 있는지 확인합니다.
</p>
<p>
