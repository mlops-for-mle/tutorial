...
<div style={{textAlign: 'center'}}>
  ...
  ![MLflow ui](./img/grafana-shape.png)  
...
networks:
  default:
    ...
    external: true
```
- `networks`: 서비스들을 연결할 도커 네트워크를 <Part>01. Database 파트</Part>에서 생성한 mlops-network 로 사용합니다. `external: true` 옵션은 `docker compose down -v` 로 이번 파트에서 생성되는 서비스를 종료하더라도 <Part>01. Database 파트</Part>에서 생성한 `mlops-network` 를 삭제하지 않을 수 있게 됩니다.
...
- 서비스가 띄워졌다면, [localhost:3000](http://localhost:3000) 을 통해 grafana에 접속하여 설정했던 아이디와 패스워드로 접속합니다.
    ...
    ![MLflow ui](./img/grafana-intro.png)  
    [그림 8-4] Grafana 접속 화면
    </div>
    <div style={{textAlign: 'center'}}>

    ![MLflow ui](./img/grafana-after-login.png)  
    [그림 8-5] Grafana 로그인 후 화면
    </div>
- 접속이 잘 되었다면 왼쪽 사이드바의 `네모 모양 > New dashboard` 버튼을 눌러줍니다.
    <div style={{textAlign: 'center'}}>

    ![MLflow ui](./img/grafana-click-new.png)  
    [그림 8-6] Grafana 새 대시보드 생성
    </div>
    <div style={{textAlign: 'center'}}>

    ![MLflowui](./img/grafana-initial-dashboard.png)  
...
- 먼저 Dashboard 에 대한 설정을 해보겠습니다.
    ...
    ![MLflow ui](./img/grafana-click-gear.png)  
...
![MLflow ui](./img/grafana-dashboard-setup.png)  
[그림 8-9] Grafana 대시보드 설정
</div>

<div style={{textAlign: 'center'}}>

![MLflow ui](./img/grafana-save-dashboard.png)  
[그림 8-10] Grafana 대시보드 저장
</div>

<div style={{textAlign: 'center'}}>

![MLflow ui](./img/grafana-after-save.png)  
...
![MLflow ui](./img/grafana-data-source-1.png)  
...
![MLflow ui](./img/grafana-data-source-2.png)  
[그림 8-13] Grafana 데이터 소스 연결 클릭
</div>

<div style={{textAlign: 'center'}}>

![MLflow ui](./img/grafana-data-source-3.png)    
[그림 8-14] Grafana 데이터 소스 검색 1
</div>

<div style={{textAlign: 'center'}}>

![MLflow ui](./img/grafana-data-source-4.png)  
...
![MLflow ui](./img/grafana-data-source-5.png)  
...
![MLflow ui](./img/grafana-data-source-6.png)  
...
![MLflow ui](./img/grafana-panel-1.png)  
...
![MLflow ui](./img/grafana-panel-2.png)  
[그림 8-19] Grafana 대시보드로 이동 2
</div>

<div style={{textAlign: 'center'}}>

![MLflow ui](./img/grafana-panel-3.png)  
...
![MLflow ui](./img/grafana-add-panel-1.png)  
[그림 8-21] Grafana 패널 생성
</div>

<div style={{textAlign: 'center'}}>

![MLflow ui](./img/grafana-add-panel-2.png)  
...
![MLflow ui](./img/grafana-set-panel-1.png)  
...
![MLflow ui](./img/grafana-save-panel-1.png)  
...
![MLflow ui](./img/grafana-set-time-1.png)  
[그림 8-25] Grafana 시각화 기간 설정
</div>

<div style={{textAlign: 'center'}}>

![MLflow ui](./img/grafana-set-time-2.png)  
...
![MLflow ui](./img/grafana-set-time-3.png)  
...
![MLflow ui](./img/grafana-data-source2-1.png)  
...
![MLflow ui](./img/grafana-data-source2-2.png)  
[그림 8-29] Grafana 추론 결과 데이터 소스 설정
</div>

- 마찬가지로 데이터 소스 연결이 성공하면 `Database Connection OK` 라는 문구가 나타납니다.
...
![MLflow ui](./img/grafana-move-to-board-1.png)  
[그림 8-31] Grafana 대시 보드로 이동
</div>

<div style={{textAlign: 'center'}}>

![MLflow ui](./img/grafana-move-to-board-2.png)  
...
![MLflow ui](./img/grafana-add-panel2.png)  
...
![MLflow ui](./img/grafana-set-panel2.png)  
[그림 8-34] Grafana 추론 패널 설정
</div>

<div style={{textAlign: 'center'}}>

![MLflow ui](./img/grafana-save-panel2.png)  
...
## 3. 완성 된 대시보드 확인
 앞서 설정해둔 대시보드의 시각화 기간과 새로고침 주기는 다시 설정 하지 않아도 적용 됩니다. 최종 시각화 결과를 확인 합니다.

<div style={{textAlign: 'center'}}>

![MLflow ui](./img/grafana-final-result.gif)  
